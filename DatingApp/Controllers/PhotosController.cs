...
{   [Authorize] 
    ...
    public class PhotosController : ControllerBase
    {
        ...
        private readonly IOptions<CloudainrySettings> _cloudinaryConfig;
        private Cloudinary _cloudinary;

        public PhotosController(IDatingRepository repo,IMapper mapper,IOptions<CloudainrySettings> cloudinaryConfig )
        {
           _repo = repo;
            _mapper = mapper;
